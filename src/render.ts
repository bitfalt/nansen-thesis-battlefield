...
import { VALIDATED_LIVE_STATUS } from './demo-metadata'
...
export function renderShell(report: StructuredReport, options: ShellRenderOptions) {
  ...
  return [
    ...
    bullet([
      ...
      `recommended profile: ${report.plannerSummary.recommendedBudgetProfile}`,
    ...
    bullet([
      ...
      ...(report.thesisProfile?.ambiguityWarning ? [`ambiguity: ${report.thesisProfile.ambiguityWarning}`] : []),
    ...
    bullet([
      ...
      `safe budget option: ${report.plannerSummary.budgetOptions.safe.maxCalls} calls / ${report.plannerSummary.budgetOptions.safe.maxCredits} credits`,
      `expanded budget option: ${report.plannerSummary.budgetOptions.expanded.maxCalls} calls / ${report.plannerSummary.budgetOptions.expanded.maxCredits} credits`,
      ...report.plannerSummary.recommendedBudgetReasoning.map((reason) => `budget note: ${reason}`),
